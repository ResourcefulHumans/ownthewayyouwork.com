...
add_action('admin_enqueue_scripts', 'rocknrolla_admin_scripts');
	...
	if (!is_admin() ){
		function rocknrolla_front_scripts(){		
            ...
            wp_register_script('rnrInit', RNR_INDEX_JS. '/init.js', array('jquery'), '2.1', true );					  
		    wp_register_script('rnrscripts', RNR_INDEX_JS .'/scripts.js', true);
			wp_register_script('rnrshortcodes', RNR_INDEX_JS .'/shortcodes.js', true);	
			...
			wp_enqueue_script('rnrshortcodes');	
